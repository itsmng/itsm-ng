...
CREATE TABLE `glpi_queuedchats` (
  ...
  `entName` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `ticketTitle` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `serverName` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `rocketHookUrl` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `mode` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT 'See Notification_NotificationTemplate::MODE_* constants',
  PRIMARY KEY (`id`),
  KEY `item` (`itemtype`,`items_id`,`notificationtemplates_id`),
  KEY `is_deleted` (`is_deleted`),

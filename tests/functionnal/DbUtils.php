...
class DbUtils extends DbTestCase
{
    ...
    **/
    ...
    public function testGetEntityRestrict()
    {
        ...
        $this->string($this->normalizeSql($it->getSql()))->isIdenticalTo('SELECT * FROM `glpi_computers`');
        ...
        $this->string($this->normalizeSql($this->testedInstance->getEntitiesRestrictRequest('WHERE', 'glpi_computers')))
        ...
        //keep testing old method from db.function
        $this->string($this->normalizeSql(getEntitiesRestrictRequest('WHERE', 'glpi_computers')))
           ->isIdenticalTo("WHERE ( `glpi_computers`.`entities_id` IN ('1', '2', '3')  ) ");
        $it->execute('glpi_computers', getEntitiesRestrictCriteria('glpi_computers'));
        $this->string($this->normalizeSql($it->getSql()))
           ->isIdenticalTo('SELECT * FROM `glpi_computers` WHERE (`glpi_computers`.`entities_id` IN (\'1\', \'2\', \'3\'))');
        ...
        // Child without table
        $this->string($this->normalizeSql($this->testedInstance->getEntitiesRestrictRequest('WHERE')))
        ...
        //keep testing old method from db.function
        $this->string($this->normalizeSql(getEntitiesRestrictRequest('WHERE')))
           ->isIdenticalTo("WHERE ( `entities_id` IN ('2')  ) ");
        ...
        $this->string($this->normalizeSql($this->testedInstance->getEntitiesRestrictRequest('WHERE', 'glpi_computers', '', '', true)))
        ...
        //keep testing old method from db.function
        $this->string($this->normalizeSql(getEntitiesRestrictRequest('WHERE', 'glpi_computers', '', '', true)))
           ->isIdenticalTo("WHERE ( `glpi_computers`.`entities_id` IN ('3')  OR (`glpi_computers`.`is_recursive`='1' AND `glpi_computers`.`entities_id` IN (0, 1)) ) ");
        ...
        $this->string($this->normalizeSql($this->testedInstance->getEntitiesRestrictRequest('WHERE', '', '', '', true)))
        ...
        //keep testing old method from db.function
        $this->string($this->normalizeSql(getEntitiesRestrictRequest('WHERE', '', '', '', true)))
           ->isIdenticalTo("WHERE ( `entities_id` IN ('3')  OR (`is_recursive`='1' AND `entities_id` IN (0, 1)) ) ");

...
class RuleRight extends DbTestCase
{
    ...
    public function testLocalAccountNoRules()
    {
        ...
        $right = array_pop($pu);
        $this->boolean($right['is_dynamic'])->isTrue();
        $this->boolean($right['is_default_profile'])->isTrue();
        ...
        $this->boolean($pu->fields['is_default_profile'])->isTrue();
        $this->boolean($pu->fields['is_dynamic'])->isTrue();

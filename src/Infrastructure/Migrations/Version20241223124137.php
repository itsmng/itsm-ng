 ...
 */
final class Version20241223124137 extends AbstractMigration
{
    ...
    'glpi_ticketrecurrents' => [
        ['name' => '8996AB3F10E3E815', 'origin' => 'tickettemplates_id', 'ref' => 'glpi_tickettemplates'],
        ['name' => '8996AB3F72C4B705', 'origin' => 'calendars_id', 'ref' => 'glpi_calendars'],
    ],
    'glpi_tickets' => [
        ['name' => '3E74569027D112BD', 'origin' => 'users_id_lastupdater', 'ref' => 'glpi_users'],
        ['name' => '3E745690BB756162', 'origin' => 'users_id_recipient', 'ref' => 'glpi_users'],
        ['name' => '3E745690D0DEA07D', 'origin' => 'requesttypes_id', 'ref' => 'glpi_requesttypes'],
        ['name' => '3E745690EFE9C34D', 'origin' => 'itilcategories_id', 'ref' => 'glpi_itilcategories'],
        ['name' => '3E745690D4107AF', 'origin' => 'slas_id_ttr', 'ref' => 'glpi_slas'],
        ['name' => '3E7456906E476B76', 'origin' => 'slas_id_tto', 'ref' => 'glpi_slas'],
        ['name' => '3E745690327F60C7', 'origin' => 'slalevels_id_ttr', 'ref' => 'glpi_slalevels'],
        ['name' => '3E745690CAAB3D7A', 'origin' => 'olas_id_tto', 'ref' => 'glpi_olas'],
        ['name' => '3E745690A9AD51A3', 'origin' => 'olas_id_ttr', 'ref' => 'glpi_olas'],
        ['name' => '3E745690737A8D91', 'origin' => 'olalevels_id_ttr', 'ref' => 'glpi_olalevels'],
        ['name' => '3E745690ED775E23', 'origin' => 'locations_id', 'ref' => 'glpi_locations'],
    ],
    'glpi_tickets_tickets' => [
        ['name' => 'C1295DC541329315', 'origin' => 'tickets_id_1', 'ref' => 'glpi_tickets'],
        ['name' => 'C1295DC5D83BC2AF', 'origin' => 'tickets_id_2', 'ref' => 'glpi_tickets'],
    ],
    'glpi_tickets_users' => [
        ['name' => 'FE269A0C8FDC0E9A', 'origin' => 'tickets_id', 'ref' => 'glpi_tickets'],
        ['name' => 'FE269A0C67B3B43D', 'origin' => 'users_id', 'ref' => 'glpi_users'],
    ],
    'glpi_ticketsatisfactions' => [
        ['name' => '9203BA78FDC0E9A', 'origin' => 'tickets_id', 'ref' => 'glpi_tickets'],
    ],
    'glpi_tickettasks' => [
        ['name' => '560FC5768FDC0E9A', 'origin' => 'tickets_id', 'ref' => 'glpi_tickets'],
        ['name' => '560FC57630D85233', 'origin' => 'taskcategories_id', 'ref' => 'glpi_taskcategories'],
        ['name' => '560FC57667B3B43D', 'origin' => 'users_id', 'ref' => 'glpi_users'],
        ['name' => '560FC5768CBB3EB6', 'origin' => 'users_id_editor', 'ref' => 'glpi_users'],
        ['name' => '560FC576FD9C58DA', 'origin' => 'users_id_tech', 'ref' => 'glpi_users'],
        ['name' => '560FC5761421F0A5', 'origin' => 'groups_id_tech', 'ref' => 'glpi_groups'],
        ['name' => '560FC5763A064358', 'origin' => 'tasktemplates_id', 'ref' => 'glpi_tasktemplates'],
    ],
    'glpi_tickettemplatehiddenfields' => [
        ['name' => '1EE1101310E3E815', 'origin' => 'tickettemplates_id', 'ref' => 'glpi_tickettemplates'],
    ],
    'glpi_tickettemplatemandatoryfields' => [
        ['name' => '4E1F9ECB10E3E815', 'origin' => 'tickettemplates_id', 'ref' => 'glpi_tickettemplates'],
    ],
    'glpi_tickettemplatepredefinedfields' => [
        ['name' => 'AE7F0EDB10E3E815', 'origin' => 'tickettemplates_id', 'ref' => 'glpi_tickettemplates'],
    ],
    'glpi_ticketvalidations' => [
        ['name' => '4E7A331767B3B43D', 'origin' => 'users_id', 'ref' => 'glpi_users'],
        ['name' => '4E7A33178FDC0E9A', 'origin' => 'tickets_id', 'ref' => 'glpi_tickets'],
        ['name' => '4E7A3317E57CE233', 'origin' => 'users_id_validate', 'ref' => 'glpi_users'],
    ],
    'glpi_useremails' => [
        ['name' => '8B7CC30567B3B43D', 'origin' => 'users_id', 'ref' => 'glpi_users'],
    ],
    'glpi_users' => [
        ['name' => 'F7E175BFED775E23', 'origin' => 'locations_id', 'ref' => 'glpi_locations'],
        ['name' => 'F7E175BF22077C89', 'origin' => 'profiles_id', 'ref' => 'glpi_profiles'],
        ['name' => 'F7E175BF9CE64CF3', 'origin' => 'usertitles_id', 'ref' => 'glpi_usertitles'],
        ['name' => 'F7E175BF78850A1C', 'origin' => 'usercategories_id', 'ref' => 'glpi_usercategories'],
        ['name' => 'F7E175BF488808A1', 'origin' => 'default_requesttypes_id', 'ref' => 'glpi_requesttypes'],
        ['name' => 'F7E175BFF373DCF', 'origin' => 'groups_id', 'ref' => 'glpi_groups'],
        ['name' => 'F7E175BFE1FE1A22', 'origin' => 'users_id_supervisor', 'ref' => 'glpi_users'],
    ],
];
        ...
        $this->addSql('ALTER TABLE glpi_budgets CHANGE entities_id entities_id INT DEFAULT 0, CHANGE locations_id locations_id INT DEFAULT NULL, CHANGE budgettypes_id budgettypes_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_changecosts CHANGE changes_id changes_id INT DEFAULT NULL, CHANGE budgets_id budgets_id INT DEFAULT NULL, CHANGE entities_id entities_id INT DEFAULT 0');
        ...
        $this->addSql('ALTER TABLE glpi_computers CHANGE entities_id entities_id INT DEFAULT 0, CHANGE users_id_tech users_id_tech INT DEFAULT NULL, CHANGE groups_id_tech groups_id_tech INT DEFAULT NULL, CHANGE locations_id locations_id INT DEFAULT NULL, CHANGE networks_id networks_id INT DEFAULT NULL, CHANGE computermodels_id computermodels_id INT DEFAULT NULL, CHANGE computertypes_id computertypes_id INT DEFAULT NULL, CHANGE manufacturers_id manufacturers_id INT DEFAULT NULL, CHANGE users_id users_id INT DEFAULT NULL, CHANGE groups_id groups_id INT DEFAULT NULL, CHANGE states_id states_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_dashboards CHANGE profileId profileId INT DEFAULT NULL, CHANGE userId userId INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_infocoms CHANGE entities_id entities_id INT DEFAULT 0, CHANGE suppliers_id suppliers_id INT DEFAULT NULL, CHANGE budgets_id budgets_id INT DEFAULT NULL, CHANGE businesscriticities_id businesscriticities_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_monitors CHANGE entities_id entities_id INT DEFAULT 0, CHANGE users_id_tech users_id_tech INT DEFAULT NULL, CHANGE groups_id_tech groups_id_tech INT DEFAULT NULL, CHANGE locations_id locations_id INT DEFAULT NULL, CHANGE monitortypes_id monitortypes_id INT DEFAULT NULL, CHANGE monitormodels_id monitormodels_id INT DEFAULT NULL, CHANGE manufacturers_id manufacturers_id INT DEFAULT NULL, CHANGE users_id users_id INT DEFAULT NULL, CHANGE groups_id groups_id INT DEFAULT NULL, CHANGE states_id states_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_networkequipments CHANGE entities_id entities_id INT DEFAULT 0, CHANGE users_id_tech users_id_tech INT DEFAULT NULL, CHANGE groups_id_tech groups_id_tech INT DEFAULT NULL, CHANGE locations_id locations_id INT DEFAULT NULL, CHANGE networks_id networks_id INT DEFAULT NULL, CHANGE networkequipmenttypes_id networkequipmenttypes_id INT DEFAULT NULL, CHANGE networkequipmentmodels_id networkequipmentmodels_id INT DEFAULT NULL, CHANGE manufacturers_id manufacturers_id INT DEFAULT NULL, CHANGE users_id users_id INT DEFAULT NULL, CHANGE groups_id groups_id INT DEFAULT NULL, CHANGE states_id states_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_peripherals CHANGE entities_id entities_id INT DEFAULT 0, CHANGE users_id_tech users_id_tech INT DEFAULT NULL, CHANGE groups_id_tech groups_id_tech INT DEFAULT NULL, CHANGE locations_id locations_id INT DEFAULT NULL, CHANGE peripheraltypes_id peripheraltypes_id INT DEFAULT NULL, CHANGE peripheralmodels_id peripheralmodels_id INT DEFAULT NULL, CHANGE manufacturers_id manufacturers_id INT DEFAULT NULL, CHANGE users_id users_id INT DEFAULT NULL, CHANGE groups_id groups_id INT DEFAULT NULL, CHANGE states_id states_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_phones CHANGE users_id_tech users_id_tech INT DEFAULT NULL, CHANGE groups_id_tech groups_id_tech INT DEFAULT NULL, CHANGE locations_id locations_id INT DEFAULT NULL, CHANGE phonetypes_id phonetypes_id INT DEFAULT NULL, CHANGE phonemodels_id phonemodels_id INT DEFAULT NULL, CHANGE phonepowersupplies_id phonepowersupplies_id INT DEFAULT NULL, CHANGE manufacturers_id manufacturers_id INT DEFAULT NULL, CHANGE users_id users_id INT DEFAULT NULL, CHANGE groups_id groups_id INT DEFAULT NULL, CHANGE states_id states_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_problemcosts CHANGE problems_id problems_id INT DEFAULT NULL, CHANGE budgets_id budgets_id INT DEFAULT NULL, CHANGE entities_id entities_id INT DEFAULT 0');
        ...
        $this->addSql('ALTER TABLE glpi_projectcosts CHANGE projects_id projects_id INT DEFAULT NULL, CHANGE budgets_id budgets_id INT DEFAULT NULL, CHANGE entities_id entities_id INT DEFAULT 0');
        ...
        $this->addSql('ALTER TABLE glpi_softwares CHANGE entities_id entities_id INT DEFAULT 0, CHANGE locations_id locations_id INT DEFAULT NULL, CHANGE users_id_tech users_id_tech INT DEFAULT NULL, CHANGE groups_id_tech groups_id_tech INT DEFAULT NULL, CHANGE softwares_id softwares_id INT DEFAULT NULL, CHANGE manufacturers_id manufacturers_id INT DEFAULT NULL, CHANGE users_id users_id INT DEFAULT NULL, CHANGE groups_id groups_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_ticketcosts CHANGE tickets_id tickets_id INT DEFAULT NULL, CHANGE budgets_id budgets_id INT DEFAULT NULL, CHANGE entities_id entities_id INT DEFAULT 0');
        ...
        $this->addSql('ALTER TABLE glpi_ticketrecurrents CHANGE entities_id entities_id INT DEFAULT 0, CHANGE tickettemplates_id tickettemplates_id INT DEFAULT NULL, CHANGE calendars_id calendars_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE glpi_ticketrecurrents ADD CONSTRAINT FK_8996AB3F6145D7DB FOREIGN KEY (entities_id) REFERENCES glpi_entities (id)');


        $this->addSql('CREATE INDEX IDX_8996AB3F72C4B705 ON glpi_ticketrecurrents (calendars_id)');
        $this->addSql('ALTER TABLE glpi_tickets CHANGE entities_id entities_id INT DEFAULT 0, CHANGE users_id_lastupdater users_id_lastupdater INT DEFAULT NULL, CHANGE users_id_recipient users_id_recipient INT DEFAULT NULL, CHANGE requesttypes_id requesttypes_id INT DEFAULT NULL, CHANGE itilcategories_id itilcategories_id INT DEFAULT NULL, CHANGE slas_id_ttr slas_id_ttr INT DEFAULT NULL, CHANGE slas_id_tto slas_id_tto INT DEFAULT NULL, CHANGE slalevels_id_ttr slalevels_id_ttr INT DEFAULT NULL, CHANGE olas_id_tto olas_id_tto INT DEFAULT NULL, CHANGE olas_id_ttr olas_id_ttr INT DEFAULT NULL, CHANGE olalevels_id_ttr olalevels_id_ttr INT DEFAULT NULL, CHANGE locations_id locations_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE glpi_tickets ADD CONSTRAINT FK_3E7456906145D7DB FOREIGN KEY (entities_id) REFERENCES glpi_entities (id)');
        ...
        $this->addSql('ALTER TABLE glpi_tickets_tickets CHANGE tickets_id_1 tickets_id_1 INT DEFAULT NULL, CHANGE tickets_id_2 tickets_id_2 INT DEFAULT NULL');


        $this->addSql('CREATE INDEX IDX_C1295DC541329315 ON glpi_tickets_tickets (tickets_id_1)');
        $this->addSql('CREATE INDEX IDX_C1295DC5D83BC2AF ON glpi_tickets_tickets (tickets_id_2)');
        $this->addSql('ALTER TABLE glpi_tickets_users CHANGE tickets_id tickets_id INT DEFAULT NULL, CHANGE users_id users_id INT DEFAULT NULL');


        $this->addSql('CREATE INDEX IDX_FE269A0C8FDC0E9A ON glpi_tickets_users (tickets_id)');
        $this->addSql('CREATE INDEX IDX_FE269A0C67B3B43D ON glpi_tickets_users (users_id)');
        $this->addSql('ALTER TABLE glpi_ticketsatisfactions CHANGE tickets_id tickets_id INT DEFAULT NULL');

        $this->addSql('ALTER TABLE glpi_tickettasks CHANGE tickets_id tickets_id INT DEFAULT NULL, CHANGE taskcategories_id taskcategories_id INT DEFAULT NULL, CHANGE users_id users_id INT DEFAULT NULL, CHANGE users_id_editor users_id_editor INT DEFAULT NULL, CHANGE users_id_tech users_id_tech INT DEFAULT NULL, CHANGE groups_id_tech groups_id_tech INT DEFAULT NULL, CHANGE tasktemplates_id tasktemplates_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_tickettemplatehiddenfields CHANGE tickettemplates_id tickettemplates_id INT DEFAULT NULL');

        $this->addSql('ALTER TABLE glpi_tickettemplatemandatoryfields CHANGE tickettemplates_id tickettemplates_id INT DEFAULT NULL');

        $this->addSql('ALTER TABLE glpi_tickettemplatepredefinedfields CHANGE tickettemplates_id tickettemplates_id INT DEFAULT NULL');

        $this->addSql('ALTER TABLE glpi_tickettemplates CHANGE entities_id entities_id INT DEFAULT 0');
        $this->addSql('ALTER TABLE glpi_tickettemplates ADD CONSTRAINT FK_C40A68156145D7DB FOREIGN KEY (entities_id) REFERENCES glpi_entities (id)');
        $this->addSql('ALTER TABLE glpi_ticketvalidations CHANGE entities_id entities_id INT DEFAULT 0, CHANGE users_id users_id INT DEFAULT NULL, CHANGE tickets_id tickets_id INT DEFAULT NULL, CHANGE users_id_validate users_id_validate INT DEFAULT NULL');
        $this->addSql('ALTER TABLE glpi_ticketvalidations ADD CONSTRAINT FK_4E7A33176145D7DB FOREIGN KEY (entities_id) REFERENCES glpi_entities (id)');



        $this->addSql('ALTER TABLE glpi_useremails CHANGE users_id users_id INT DEFAULT NULL');

        $this->addSql('CREATE INDEX IDX_8B7CC30567B3B43D ON glpi_useremails (users_id)');
        $this->addSql('ALTER TABLE glpi_users CHANGE locations_id locations_id INT DEFAULT NULL, CHANGE profiles_id profiles_id INT DEFAULT NULL, CHANGE entities_id entities_id INT DEFAULT 0, CHANGE usertitles_id usertitles_id INT DEFAULT NULL, CHANGE usercategories_id usercategories_id INT DEFAULT NULL, CHANGE groups_id groups_id INT DEFAULT NULL, CHANGE users_id_supervisor users_id_supervisor INT DEFAULT NULL');


        $this->addSql('ALTER TABLE glpi_users ADD CONSTRAINT FK_F7E175BF6145D7DB FOREIGN KEY (entities_id) REFERENCES glpi_entities (id)');





        $this->addSql('CREATE INDEX IDX_F7E175BF488808A1 ON glpi_users (default_requesttypes_id)');
        $this->addSql('ALTER TABLE glpi_vlans CHANGE entities_id entities_id INT DEFAULT 0');
        $this->addSql('ALTER TABLE glpi_vlans ADD CONSTRAINT FK_5945BD276145D7DB FOREIGN KEY (entities_id) REFERENCES glpi_entities (id)');
        $this->addSql('ALTER TABLE glpi_wifinetworks CHANGE entities_id entities_id INT DEFAULT 0');
        $this->addSql('ALTER TABLE glpi_wifinetworks ADD CONSTRAINT FK_E53F247A6145D7DB FOREIGN KEY (entities_id) REFERENCES glpi_entities (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE glpi_budgets CHANGE entities_id entities_id INT DEFAULT 0 NOT NULL, CHANGE locations_id locations_id INT DEFAULT 0 NOT NULL, CHANGE budgettypes_id budgettypes_id INT DEFAULT 0 NOT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_changecosts CHANGE changes_id changes_id INT DEFAULT 0 NOT NULL, CHANGE budgets_id budgets_id INT DEFAULT 0 NOT NULL, CHANGE entities_id entities_id INT DEFAULT 0 NOT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_computers CHANGE entities_id entities_id INT DEFAULT 0 NOT NULL, CHANGE users_id_tech users_id_tech INT DEFAULT 0 NOT NULL, CHANGE groups_id_tech groups_id_tech INT DEFAULT 0 NOT NULL, CHANGE locations_id locations_id INT DEFAULT 0 NOT NULL, CHANGE networks_id networks_id INT DEFAULT 0 NOT NULL, CHANGE computermodels_id computermodels_id INT DEFAULT 0 NOT NULL, CHANGE computertypes_id computertypes_id INT DEFAULT 0 NOT NULL, CHANGE manufacturers_id manufacturers_id INT DEFAULT 0 NOT NULL, CHANGE users_id users_id INT DEFAULT 0 NOT NULL, CHANGE groups_id groups_id INT DEFAULT 0 NOT NULL, CHANGE states_id states_id INT DEFAULT 0 NOT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_dashboards CHANGE profileId profileId INT DEFAULT 0 NOT NULL, CHANGE userId userId INT DEFAULT 0 NOT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_infocoms CHANGE entities_id entities_id INT DEFAULT 0 NOT NULL, CHANGE suppliers_id suppliers_id INT DEFAULT 0 NOT NULL, CHANGE budgets_id budgets_id INT DEFAULT 0 NOT NULL, CHANGE businesscriticities_id businesscriticities_id INT DEFAULT 0 NOT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_monitors CHANGE entities_id entities_id INT DEFAULT 0 NOT NULL, CHANGE users_id_tech users_id_tech INT DEFAULT 0 NOT NULL, CHANGE groups_id_tech groups_id_tech INT DEFAULT 0 NOT NULL, CHANGE locations_id locations_id INT DEFAULT 0 NOT NULL, CHANGE monitortypes_id monitortypes_id INT DEFAULT 0 NOT NULL, CHANGE monitormodels_id monitormodels_id INT DEFAULT 0 NOT NULL, CHANGE manufacturers_id manufacturers_id INT DEFAULT 0 NOT NULL, CHANGE users_id users_id INT DEFAULT 0 NOT NULL, CHANGE groups_id groups_id INT DEFAULT 0 NOT NULL, CHANGE states_id states_id INT DEFAULT 0 NOT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_networkequipments CHANGE entities_id entities_id INT DEFAULT 0 NOT NULL, CHANGE users_id_tech users_id_tech INT DEFAULT 0 NOT NULL, CHANGE groups_id_tech groups_id_tech INT DEFAULT 0 NOT NULL, CHANGE locations_id locations_id INT DEFAULT 0 NOT NULL, CHANGE networks_id networks_id INT DEFAULT 0 NOT NULL, CHANGE networkequipmenttypes_id networkequipmenttypes_id INT DEFAULT 0 NOT NULL, CHANGE networkequipmentmodels_id networkequipmentmodels_id INT DEFAULT 0 NOT NULL, CHANGE manufacturers_id manufacturers_id INT DEFAULT 0 NOT NULL, CHANGE users_id users_id INT DEFAULT 0 NOT NULL, CHANGE groups_id groups_id INT DEFAULT 0 NOT NULL, CHANGE states_id states_id INT DEFAULT 0 NOT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_peripherals CHANGE entities_id entities_id INT DEFAULT 0 NOT NULL, CHANGE users_id_tech users_id_tech INT DEFAULT 0 NOT NULL, CHANGE groups_id_tech groups_id_tech INT DEFAULT 0 NOT NULL, CHANGE locations_id locations_id INT DEFAULT 0 NOT NULL, CHANGE peripheraltypes_id peripheraltypes_id INT DEFAULT 0 NOT NULL, CHANGE peripheralmodels_id peripheralmodels_id INT DEFAULT 0 NOT NULL, CHANGE manufacturers_id manufacturers_id INT DEFAULT 0 NOT NULL, CHANGE users_id users_id INT DEFAULT 0 NOT NULL, CHANGE groups_id groups_id INT DEFAULT 0 NOT NULL, CHANGE states_id states_id INT DEFAULT 0 NOT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_phones CHANGE users_id_tech users_id_tech INT DEFAULT 0 NOT NULL, CHANGE groups_id_tech groups_id_tech INT DEFAULT 0 NOT NULL, CHANGE locations_id locations_id INT DEFAULT 0 NOT NULL, CHANGE phonetypes_id phonetypes_id INT DEFAULT 0 NOT NULL, CHANGE phonemodels_id phonemodels_id INT DEFAULT 0 NOT NULL, CHANGE phonepowersupplies_id phonepowersupplies_id INT DEFAULT 0 NOT NULL, CHANGE manufacturers_id manufacturers_id INT DEFAULT 0 NOT NULL, CHANGE users_id users_id INT DEFAULT 0 NOT NULL, CHANGE groups_id groups_id INT DEFAULT 0 NOT NULL, CHANGE states_id states_id INT DEFAULT 0 NOT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_problemcosts CHANGE problems_id problems_id INT DEFAULT 0 NOT NULL, CHANGE budgets_id budgets_id INT DEFAULT 0 NOT NULL, CHANGE entities_id entities_id INT DEFAULT 0 NOT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_projectcosts CHANGE projects_id projects_id INT DEFAULT 0 NOT NULL, CHANGE budgets_id budgets_id INT DEFAULT 0 NOT NULL, CHANGE entities_id entities_id INT DEFAULT 0 NOT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_softwares CHANGE entities_id entities_id INT DEFAULT 0 NOT NULL, CHANGE locations_id locations_id INT DEFAULT 0 NOT NULL, CHANGE users_id_tech users_id_tech INT DEFAULT 0 NOT NULL, CHANGE groups_id_tech groups_id_tech INT DEFAULT 0 NOT NULL, CHANGE softwares_id softwares_id INT DEFAULT 0 NOT NULL, CHANGE manufacturers_id manufacturers_id INT DEFAULT 0 NOT NULL, CHANGE users_id users_id INT DEFAULT 0 NOT NULL, CHANGE groups_id groups_id INT DEFAULT 0 NOT NULL');
        ...
        $this->addSql('ALTER TABLE glpi_ticketcosts CHANGE tickets_id tickets_id INT DEFAULT 0 NOT NULL, CHANGE budgets_id budgets_id INT DEFAULT 0 NOT NULL, CHANGE entities_id entities_id INT DEFAULT 0 NOT NULL');
        $this->addSql('ALTER TABLE glpi_ticketrecurrents DROP FOREIGN KEY FK_8996AB3F6145D7DB');
        $this->addSql('ALTER TABLE glpi_ticketrecurrents DROP FOREIGN KEY FK_8996AB3F10E3E815');
        $this->addSql('ALTER TABLE glpi_ticketrecurrents DROP FOREIGN KEY FK_8996AB3F72C4B705');
        $this->addSql('DROP INDEX IDX_8996AB3F72C4B705 ON glpi_ticketrecurrents');
        $this->addSql('ALTER TABLE glpi_ticketrecurrents CHANGE entities_id entities_id INT DEFAULT 0 NOT NULL, CHANGE tickettemplates_id tickettemplates_id INT DEFAULT 0 NOT NULL, CHANGE calendars_id calendars_id INT DEFAULT 0 NOT NULL');
        $this->addSql('ALTER TABLE glpi_tickets DROP FOREIGN KEY FK_3E7456906145D7DB');
        $this->addSql('ALTER TABLE glpi_tickets DROP FOREIGN KEY FK_3E74569027D112BD');
        $this->addSql('ALTER TABLE glpi_tickets DROP FOREIGN KEY FK_3E745690BB756162');
        $this->addSql('ALTER TABLE glpi_tickets DROP FOREIGN KEY FK_3E745690D0DEA07D');
        $this->addSql('ALTER TABLE glpi_tickets DROP FOREIGN KEY FK_3E745690EFE9C34D');
        $this->addSql('ALTER TABLE glpi_tickets DROP FOREIGN KEY FK_3E745690D4107AF');
        $this->addSql('ALTER TABLE glpi_tickets DROP FOREIGN KEY FK_3E7456906E476B76');
        $this->addSql('ALTER TABLE glpi_tickets DROP FOREIGN KEY FK_3E745690327F60C7');
        $this->addSql('ALTER TABLE glpi_tickets DROP FOREIGN KEY FK_3E745690CAAB3D7A');
        $this->addSql('ALTER TABLE glpi_tickets DROP FOREIGN KEY FK_3E745690A9AD51A3');
        $this->addSql('ALTER TABLE glpi_tickets DROP FOREIGN KEY FK_3E745690737A8D91');
        $this->addSql('ALTER TABLE glpi_tickets DROP FOREIGN KEY FK_3E745690ED775E23');
        $this->addSql('ALTER TABLE glpi_tickets CHANGE entities_id entities_id INT DEFAULT 0 NOT NULL, CHANGE users_id_lastupdater users_id_lastupdater INT DEFAULT 0 NOT NULL, CHANGE users_id_recipient users_id_recipient INT DEFAULT 0 NOT NULL, CHANGE requesttypes_id requesttypes_id INT DEFAULT 0 NOT NULL, CHANGE itilcategories_id itilcategories_id INT DEFAULT 0 NOT NULL, CHANGE slas_id_ttr slas_id_ttr INT DEFAULT 0 NOT NULL, CHANGE slas_id_tto slas_id_tto INT DEFAULT 0 NOT NULL, CHANGE slalevels_id_ttr slalevels_id_ttr INT DEFAULT 0 NOT NULL, CHANGE olas_id_tto olas_id_tto INT DEFAULT 0 NOT NULL, CHANGE olas_id_ttr olas_id_ttr INT DEFAULT 0 NOT NULL, CHANGE olalevels_id_ttr olalevels_id_ttr INT DEFAULT 0 NOT NULL, CHANGE locations_id locations_id INT DEFAULT 0 NOT NULL');
        $this->addSql('ALTER TABLE glpi_tickets_tickets DROP FOREIGN KEY FK_C1295DC541329315');
        $this->addSql('ALTER TABLE glpi_tickets_tickets DROP FOREIGN KEY FK_C1295DC5D83BC2AF');
        $this->addSql('DROP INDEX IDX_C1295DC541329315 ON glpi_tickets_tickets');
        $this->addSql('DROP INDEX IDX_C1295DC5D83BC2AF ON glpi_tickets_tickets');
        $this->addSql('ALTER TABLE glpi_tickets_tickets CHANGE tickets_id_1 tickets_id_1 INT DEFAULT 0 NOT NULL, CHANGE tickets_id_2 tickets_id_2 INT DEFAULT 0 NOT NULL');
        $this->addSql('ALTER TABLE glpi_tickets_users DROP FOREIGN KEY FK_FE269A0C8FDC0E9A');
        $this->addSql('ALTER TABLE glpi_tickets_users DROP FOREIGN KEY FK_FE269A0C67B3B43D');
        $this->addSql('DROP INDEX IDX_FE269A0C8FDC0E9A ON glpi_tickets_users');
        $this->addSql('DROP INDEX IDX_FE269A0C67B3B43D ON glpi_tickets_users');
        $this->addSql('ALTER TABLE glpi_tickets_users CHANGE tickets_id tickets_id INT DEFAULT 0 NOT NULL, CHANGE users_id users_id INT DEFAULT 0 NOT NULL');
        $this->addSql('ALTER TABLE glpi_ticketsatisfactions DROP FOREIGN KEY FK_9203BA78FDC0E9A');
        $this->addSql('ALTER TABLE glpi_ticketsatisfactions CHANGE tickets_id tickets_id INT DEFAULT 0 NOT NULL');
        $this->addSql('ALTER TABLE glpi_tickettasks DROP FOREIGN KEY FK_560FC5768FDC0E9A');
        $this->addSql('ALTER TABLE glpi_tickettasks DROP FOREIGN KEY FK_560FC57630D85233');
        $this->addSql('ALTER TABLE glpi_tickettasks DROP FOREIGN KEY FK_560FC57667B3B43D');
        $this->addSql('ALTER TABLE glpi_tickettasks DROP FOREIGN KEY FK_560FC5768CBB3EB6');
        $this->addSql('ALTER TABLE glpi_tickettasks DROP FOREIGN KEY FK_560FC576FD9C58DA');
        $this->addSql('ALTER TABLE glpi_tickettasks DROP FOREIGN KEY FK_560FC5761421F0A5');
        $this->addSql('ALTER TABLE glpi_tickettasks DROP FOREIGN KEY FK_560FC5763A064358');
        $this->addSql('ALTER TABLE glpi_tickettasks CHANGE tickets_id tickets_id INT DEFAULT 0 NOT NULL, CHANGE taskcategories_id taskcategories_id INT DEFAULT 0 NOT NULL, CHANGE users_id users_id INT DEFAULT 0 NOT NULL, CHANGE users_id_editor users_id_editor INT DEFAULT 0 NOT NULL, CHANGE users_id_tech users_id_tech INT DEFAULT 0 NOT NULL, CHANGE groups_id_tech groups_id_tech INT DEFAULT 0 NOT NULL, CHANGE tasktemplates_id tasktemplates_id INT DEFAULT 0 NOT NULL');
        $this->addSql('ALTER TABLE glpi_tickettemplatehiddenfields DROP FOREIGN KEY FK_1EE1101310E3E815');
        $this->addSql('ALTER TABLE glpi_tickettemplatehiddenfields CHANGE tickettemplates_id tickettemplates_id INT DEFAULT 0 NOT NULL');
        $this->addSql('ALTER TABLE glpi_tickettemplatemandatoryfields DROP FOREIGN KEY FK_4E1F9ECB10E3E815');
        $this->addSql('ALTER TABLE glpi_tickettemplatemandatoryfields CHANGE tickettemplates_id tickettemplates_id INT DEFAULT 0 NOT NULL');
        $this->addSql('ALTER TABLE glpi_tickettemplatepredefinedfields DROP FOREIGN KEY FK_AE7F0EDB10E3E815');
        $this->addSql('ALTER TABLE glpi_tickettemplatepredefinedfields CHANGE tickettemplates_id tickettemplates_id INT DEFAULT 0 NOT NULL');
        $this->addSql('ALTER TABLE glpi_tickettemplates DROP FOREIGN KEY FK_C40A68156145D7DB');
        $this->addSql('ALTER TABLE glpi_tickettemplates CHANGE entities_id entities_id INT DEFAULT 0 NOT NULL');
        $this->addSql('ALTER TABLE glpi_ticketvalidations DROP FOREIGN KEY FK_4E7A33176145D7DB');
        $this->addSql('ALTER TABLE glpi_ticketvalidations DROP FOREIGN KEY FK_4E7A331767B3B43D');
        $this->addSql('ALTER TABLE glpi_ticketvalidations DROP FOREIGN KEY FK_4E7A33178FDC0E9A');
        $this->addSql('ALTER TABLE glpi_ticketvalidations DROP FOREIGN KEY FK_4E7A3317E57CE233');
        $this->addSql('ALTER TABLE glpi_ticketvalidations CHANGE entities_id entities_id INT DEFAULT 0 NOT NULL, CHANGE users_id users_id INT DEFAULT 0 NOT NULL, CHANGE tickets_id tickets_id INT DEFAULT 0 NOT NULL, CHANGE users_id_validate users_id_validate INT DEFAULT 0 NOT NULL');
        $this->addSql('ALTER TABLE glpi_useremails DROP FOREIGN KEY FK_8B7CC30567B3B43D');
        $this->addSql('DROP INDEX IDX_8B7CC30567B3B43D ON glpi_useremails');
        $this->addSql('ALTER TABLE glpi_useremails CHANGE users_id users_id INT DEFAULT 0 NOT NULL');
        $this->addSql('ALTER TABLE glpi_users DROP FOREIGN KEY FK_F7E175BFED775E23');
        $this->addSql('ALTER TABLE glpi_users DROP FOREIGN KEY FK_F7E175BF22077C89');
        $this->addSql('ALTER TABLE glpi_users DROP FOREIGN KEY FK_F7E175BF6145D7DB');
        $this->addSql('ALTER TABLE glpi_users DROP FOREIGN KEY FK_F7E175BF9CE64CF3');
        $this->addSql('ALTER TABLE glpi_users DROP FOREIGN KEY FK_F7E175BF78850A1C');
        $this->addSql('ALTER TABLE glpi_users DROP FOREIGN KEY FK_F7E175BF488808A1');
        $this->addSql('ALTER TABLE glpi_users DROP FOREIGN KEY FK_F7E175BFF373DCF');
        $this->addSql('ALTER TABLE glpi_users DROP FOREIGN KEY FK_F7E175BFE1FE1A22');
        $this->addSql('DROP INDEX IDX_F7E175BF488808A1 ON glpi_users');
        $this->addSql('ALTER TABLE glpi_users CHANGE locations_id locations_id INT DEFAULT 0 NOT NULL, CHANGE profiles_id profiles_id INT DEFAULT 0 NOT NULL, CHANGE entities_id entities_id INT DEFAULT 0 NOT NULL, CHANGE usertitles_id usertitles_id INT DEFAULT 0 NOT NULL, CHANGE usercategories_id usercategories_id INT DEFAULT 0 NOT NULL, CHANGE groups_id groups_id INT DEFAULT 0 NOT NULL, CHANGE users_id_supervisor users_id_supervisor INT DEFAULT 0 NOT NULL');
        $this->addSql('ALTER TABLE glpi_vlans DROP FOREIGN KEY FK_5945BD276145D7DB');
        $this->addSql('ALTER TABLE glpi_vlans CHANGE entities_id entities_id INT DEFAULT 0 NOT NULL');
        $this->addSql('ALTER TABLE glpi_wifinetworks DROP FOREIGN KEY FK_E53F247A6145D7DB');
        $this->addSql('ALTER TABLE glpi_wifinetworks CHANGE entities_id entities_id INT DEFAULT 0 NOT NULL');
    }
}

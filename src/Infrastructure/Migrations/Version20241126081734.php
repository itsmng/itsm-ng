 ...
 */
final class Version20241126081734 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE glpi_changes_problems (id INT AUTO_INCREMENT NOT NULL, changes_id INT DEFAULT 0 NOT NULL, problems_id INT DEFAULT 0 NOT NULL, INDEX problems_id (problems_id), UNIQUE INDEX unicity (changes_id, problems_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1010Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1010Platform'."
        );
        ...
        $this->addSql('CREATE TABLE glpi_changes_tickets (id INT AUTO_INCREMENT NOT NULL, changes_id INT DEFAULT 0 NOT NULL, tickets_id INT DEFAULT 0 NOT NULL, UNIQUE INDEX unicity (changes_id, tickets_id), INDEX tickets_id (tickets_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1010Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1010Platform'."
        );
        ...
        $this->addSql('CREATE TABLE glpi_devicepcis (id INT AUTO_INCREMENT NOT NULL, designation VARCHAR(255) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, comment TEXT CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, manufacturers_id INT DEFAULT 0 NOT NULL, devicenetworkcardmodels_id INT DEFAULT 0 NOT NULL, entities_id INT DEFAULT 0 NOT NULL, is_recursive TINYINT(1) DEFAULT 0 NOT NULL, devicepcimodels_id INT DEFAULT NULL, date_mod DATETIME DEFAULT NULL, date_creation DATETIME DEFAULT NULL, INDEX devicenetworkcardmodels_id (devicenetworkcardmodels_id), INDEX devicepcimodels_id (devicepcimodels_id), INDEX is_recursive (is_recursive), INDEX entities_id (entities_id), INDEX designation (designation), INDEX date_mod (date_mod), INDEX manufacturers_id (manufacturers_id), INDEX date_creation (date_creation), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1010Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1010Platform'."
        );
        ...
        $this->addSql('CREATE TABLE glpi_devicesimcards (id INT AUTO_INCREMENT NOT NULL, designation VARCHAR(255) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, comment TEXT CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, entities_id INT DEFAULT 0 NOT NULL, is_recursive TINYINT(1) DEFAULT 0 NOT NULL, manufacturers_id INT DEFAULT 0 NOT NULL, voltage INT DEFAULT NULL, devicesimcardtypes_id INT DEFAULT 0 NOT NULL, date_mod DATETIME DEFAULT NULL, date_creation DATETIME DEFAULT NULL, allow_voip TINYINT(1) DEFAULT 0 NOT NULL, INDEX manufacturers_id (manufacturers_id), INDEX devicesimcardtypes_id (devicesimcardtypes_id), INDEX designation (designation), INDEX date_mod (date_mod), INDEX entities_id (entities_id), INDEX date_creation (date_creation), INDEX is_recursive (is_recursive), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1010Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1010Platform'."
        );
        ...
        $this->addSql('CREATE TABLE glpi_items_devicecontrols (id INT AUTO_INCREMENT NOT NULL, items_id INT DEFAULT 0 NOT NULL, itemtype VARCHAR(255) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, devicecontrols_id INT DEFAULT 0 NOT NULL, is_deleted TINYINT(1) DEFAULT 0 NOT NULL, is_dynamic TINYINT(1) DEFAULT 0 NOT NULL, entities_id INT DEFAULT 0 NOT NULL, is_recursive TINYINT(1) DEFAULT 0 NOT NULL, serial VARCHAR(255) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, busID VARCHAR(255) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, otherserial VARCHAR(255) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, locations_id INT DEFAULT 0 NOT NULL, states_id INT DEFAULT 0 NOT NULL, INDEX states_id (states_id), INDEX serial (serial), INDEX is_dynamic (is_dynamic), INDEX computers_id (items_id), INDEX otherserial (otherserial), INDEX busID (busID), INDEX entities_id (entities_id), INDEX devicecontrols_id (devicecontrols_id), INDEX locations_id (locations_id), INDEX item (itemtype, items_id), INDEX is_recursive (is_recursive), INDEX is_deleted (is_deleted), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1010Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1010Platform'."
        );

        $this->addSql('CREATE TABLE glpi_items_devicedrives (id INT AUTO_INCREMENT NOT NULL, items_id INT DEFAULT 0 NOT NULL, itemtype VARCHAR(255) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, devicedrives_id INT DEFAULT 0 NOT NULL, is_deleted TINYINT(1) DEFAULT 0 NOT NULL, is_dynamic TINYINT(1) DEFAULT 0 NOT NULL, entities_id INT DEFAULT 0 NOT NULL, is_recursive TINYINT(1) DEFAULT 0 NOT NULL, serial VARCHAR(255) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, busID VARCHAR(255) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, otherserial VARCHAR(255) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, locations_id INT DEFAULT 0 NOT NULL, states_id INT DEFAULT 0 NOT NULL, INDEX devicedrives_id (devicedrives_id), INDEX locations_id (locations_id), INDEX item (itemtype, items_id), INDEX is_recursive (is_recursive), INDEX is_deleted (is_deleted), INDEX states_id (states_id), INDEX serial (serial), INDEX is_dynamic (is_dynamic), INDEX computers_id (items_id), INDEX otherserial (otherserial), INDEX busID (busID), INDEX entities_id (entities_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1010Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1010Platform'."
        );

        $this->addSql('CREATE TABLE glpi_items_devicefirmwares (id INT AUTO_INCREMENT NOT NULL, items_id INT DEFAULT 0 NOT NULL, itemtype VARCHAR(255) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, devicefirmwares_id INT DEFAULT 0 NOT NULL, is_deleted TINYINT(1) DEFAULT 0 NOT NULL, is_dynamic TINYINT(1) DEFAULT 0 NOT NULL, entities_id INT DEFAULT 0 NOT NULL, is_recursive TINYINT(1) DEFAULT 0 NOT NULL, serial VARCHAR(255) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, otherserial VARCHAR(255) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, locations_id INT DEFAULT 0 NOT NULL, states_id INT DEFAULT 0 NOT NULL, INDEX is_dynamic (is_dynamic), INDEX computers_id (items_id), INDEX item (itemtype, items_id), INDEX entities_id (entities_id), INDEX devicefirmwares_id (devicefirmwares_id), INDEX is_recursive (is_recursive), INDEX is_deleted (is_deleted), INDEX otherserial (otherserial), INDEX serial (serial), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1010Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1010Platform'."
        );
        ...
        $this->addSql('CREATE TABLE glpi_items_softwarelicenses (id INT AUTO_INCREMENT NOT NULL, items_id INT DEFAULT 0 NOT NULL, itemtype VARCHAR(100) CHARACTER SET utf8mb3 NOT NULL COLLATE `utf8mb3_unicode_ci`, softwarelicenses_id INT DEFAULT 0 NOT NULL, is_deleted TINYINT(1) DEFAULT 0 NOT NULL, is_dynamic TINYINT(1) DEFAULT 0 NOT NULL, INDEX itemtype (itemtype), INDEX is_deleted (is_deleted), INDEX item (itemtype, items_id), INDEX is_dynamic (is_dynamic), INDEX items_id (items_id), INDEX softwarelicenses_id (softwarelicenses_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1010Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1010Platform'."
        );

        $this->addSql('CREATE TABLE glpi_items_softwareversions (id INT AUTO_INCREMENT NOT NULL, items_id INT DEFAULT 0 NOT NULL, itemtype VARCHAR(100) CHARACTER SET utf8mb3 NOT NULL COLLATE `utf8mb3_unicode_ci`, softwareversions_id INT DEFAULT 0 NOT NULL, is_deleted_item TINYINT(1) DEFAULT 0 NOT NULL, is_template_item TINYINT(1) DEFAULT 0 NOT NULL, entities_id INT DEFAULT 0 NOT NULL, is_deleted TINYINT(1) DEFAULT 0 NOT NULL, is_dynamic TINYINT(1) DEFAULT 0 NOT NULL, date_install DATE DEFAULT NULL, INDEX items_id (items_id), UNIQUE INDEX unicity (itemtype, items_id, softwareversions_id), INDEX is_dynamic (is_dynamic), INDEX softwareversions_id (softwareversions_id), INDEX itemtype (itemtype), INDEX date_install (date_install), INDEX is_template (is_template_item), INDEX computers_info (entities_id, is_template_item, is_deleted_item), INDEX item (itemtype, items_id), INDEX is_deleted (is_deleted_item), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1010Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1010Platform'."
        );
        ...
        $this->addSql('CREATE TABLE glpi_networkportaliases (id INT AUTO_INCREMENT NOT NULL, networkports_id INT DEFAULT 0 NOT NULL, networkports_id_alias INT DEFAULT 0 NOT NULL, date_mod DATETIME DEFAULT NULL, date_creation DATETIME DEFAULT NULL, INDEX networkports_id_alias (networkports_id_alias), INDEX date_mod (date_mod), INDEX date_creation (date_creation), UNIQUE INDEX networkports_id (networkports_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1010Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1010Platform'."
        );
        ...
        $this->addSql('CREATE TABLE glpi_notifications_notificationtemplates (id INT AUTO_INCREMENT NOT NULL, notifications_id INT DEFAULT 0 NOT NULL, mode VARCHAR(20) CHARACTER SET utf8mb3 NOT NULL COLLATE `utf8mb3_unicode_ci` COMMENT \'See Notification_NotificationTemplate::MODE_* constants\', notificationtemplates_id INT DEFAULT 0 NOT NULL, INDEX notificationtemplates_id (notificationtemplates_id), INDEX mode (mode), INDEX notifications_id (notifications_id), UNIQUE INDEX unicity (notifications_id, mode, notificationtemplates_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1010Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1010Platform'."
        );

        $this->addSql('CREATE TABLE glpi_notificationtargets (id INT AUTO_INCREMENT NOT NULL, items_id INT DEFAULT 0 NOT NULL, type INT DEFAULT 0 NOT NULL, notifications_id INT DEFAULT 0 NOT NULL, INDEX items (type, items_id), INDEX notifications_id (notifications_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1010Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1010Platform'."
        );
        ...
        $this->addSql('CREATE TABLE glpi_problemcosts (id INT AUTO_INCREMENT NOT NULL, problems_id INT DEFAULT 0 NOT NULL, name VARCHAR(255) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, comment TEXT CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, begin_date DATE DEFAULT NULL, end_date DATE DEFAULT NULL, actiontime INT DEFAULT 0 NOT NULL, cost_time NUMERIC(20, 4) DEFAULT \'0.0000\' NOT NULL, cost_fixed NUMERIC(20, 4) DEFAULT \'0.0000\' NOT NULL, cost_material NUMERIC(20, 4) DEFAULT \'0.0000\' NOT NULL, budgets_id INT DEFAULT 0 NOT NULL, entities_id INT DEFAULT 0 NOT NULL, INDEX entities_id (entities_id), INDEX problems_id (problems_id), INDEX budgets_id (budgets_id), INDEX begin_date (begin_date), INDEX end_date (end_date), INDEX name (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1010Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1010Platform'."
        );

        $this->addSql('CREATE TABLE glpi_problems (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, entities_id INT DEFAULT 0 NOT NULL, is_recursive TINYINT(1) DEFAULT 0 NOT NULL, is_deleted TINYINT(1) DEFAULT 0 NOT NULL, status INT DEFAULT 1 NOT NULL, content LONGTEXT CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, date_mod DATETIME DEFAULT NULL, date DATETIME DEFAULT NULL, solvedate DATETIME DEFAULT NULL, closedate DATETIME DEFAULT NULL, time_to_resolve DATETIME DEFAULT NULL, users_id_recipient INT DEFAULT 0 NOT NULL, users_id_lastupdater INT DEFAULT 0 NOT NULL, urgency INT DEFAULT 1 NOT NULL, impact INT DEFAULT 1 NOT NULL, priority INT DEFAULT 1 NOT NULL, itilcategories_id INT DEFAULT 0 NOT NULL, impactcontent LONGTEXT CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, causecontent LONGTEXT CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, symptomcontent LONGTEXT CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, actiontime INT DEFAULT 0 NOT NULL, begin_waiting_date DATETIME DEFAULT NULL, waiting_duration INT DEFAULT 0 NOT NULL, close_delay_stat INT DEFAULT 0 NOT NULL, solve_delay_stat INT DEFAULT 0 NOT NULL, date_creation DATETIME DEFAULT NULL, INDEX date_creation (date_creation), INDEX name (name), INDEX impact (impact), INDEX users_id_recipient (users_id_recipient), INDEX priority (priority), INDEX date (date), INDEX entities_id (entities_id), INDEX time_to_resolve (time_to_resolve), INDEX solvedate (solvedate), INDEX date_mod (date_mod), INDEX closedate (closedate), INDEX is_recursive (is_recursive), INDEX users_id_lastupdater (users_id_lastupdater), INDEX urgency (urgency), INDEX itilcategories_id (itilcategories_id), INDEX status (status), INDEX is_deleted (is_deleted), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1010Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1010Platform'."
        );
        ...
        $this->addSql('CREATE TABLE glpi_problemtemplatemandatoryfields (id INT AUTO_INCREMENT NOT NULL, problemtemplates_id INT DEFAULT 0 NOT NULL, num INT DEFAULT 0 NOT NULL, UNIQUE INDEX unicity (problemtemplates_id, num), INDEX problemtemplates_id (problemtemplates_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1010Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1010Platform'."
        );
        ...
        $this->addSql('CREATE TABLE glpi_taskcategories (id INT AUTO_INCREMENT NOT NULL, entities_id INT DEFAULT 0 NOT NULL, is_recursive TINYINT(1) DEFAULT 0 NOT NULL, taskcategories_id INT DEFAULT 0 NOT NULL, name VARCHAR(255) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, completename TEXT CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, comment TEXT CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, level INT DEFAULT 0 NOT NULL, ancestors_cache LONGTEXT CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, sons_cache LONGTEXT CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, is_active TINYINT(1) DEFAULT 1 NOT NULL, is_helpdeskvisible TINYINT(1) DEFAULT 1 NOT NULL, date_mod DATETIME DEFAULT NULL, date_creation DATETIME DEFAULT NULL, knowbaseitemcategories_id INT DEFAULT 0 NOT NULL, INDEX is_helpdeskvisible (is_helpdeskvisible), INDEX entities_id (entities_id), INDEX date_mod (date_mod), INDEX is_recursive (is_recursive), INDEX name (name), INDEX date_creation (date_creation), INDEX is_active (is_active), INDEX taskcategories_id (taskcategories_id), INDEX knowbaseitemcategories_id (knowbaseitemcategories_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1010Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1010Platform'."
        );
        ...
        $this->addSql('CREATE TABLE glpi_ticketcosts (id INT AUTO_INCREMENT NOT NULL, tickets_id INT DEFAULT 0 NOT NULL, name VARCHAR(255) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, comment TEXT CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, begin_date DATE DEFAULT NULL, end_date DATE DEFAULT NULL, actiontime INT DEFAULT 0 NOT NULL, cost_time NUMERIC(20, 4) DEFAULT \'0.0000\' NOT NULL, cost_fixed NUMERIC(20, 4) DEFAULT \'0.0000\' NOT NULL, cost_material NUMERIC(20, 4) DEFAULT \'0.0000\' NOT NULL, budgets_id INT DEFAULT 0 NOT NULL, entities_id INT DEFAULT 0 NOT NULL, INDEX tickets_id (tickets_id), INDEX budgets_id (budgets_id), INDEX begin_date (begin_date), INDEX end_date (end_date), INDEX name (name), INDEX entities_id (entities_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1010Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1010Platform'."
        );

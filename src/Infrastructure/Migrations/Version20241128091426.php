...
final class Version20241128091426 extends AbstractMigration
{
    ...
    private function switchToDatetime($table, $column)
    {
        ...
        $this->addSql('ALTER TABLE '.$table.' CHANGE temp_'.$column.' '.$column.' DATETIME DEFAULT CURRENT_TIMESTAMP');
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->switchToDatetime('glpi_computers', 'date_creation');
        ...
        $this->addSql('ALTER TABLE glpi_crontasks CHANGE date_mod date_mod TIMESTAMP DEFAULT CURRENT_TIMESTAMP');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE glpi_computers CHANGE date_mod date_mod DATETIME DEFAULT NULL, CHANGE ticket_tco ticket_tco NUMERIC(20, 4) DEFAULT \'0.0000\'');

...
#[ORM\Index(name: "devicesoundcards_id", columns: ["devicesoundcards_id"])]
...
class ItemDeviceSoundCard
{
    ...
    {
        return $this->devicesoundcards_id;
    }

    public function setDevicesoundcardsId(int $devicesoundcards_id): self
    {
        $this->devicesoundcards_id = $devicesoundcards_id;

...
class ItemDeviceGeneric
{
    ...
    {
        return $this->devicegenerics_id;
    }

    public function setDevicegenericsId(int $devicegenerics_id): self
    {
        $this->devicegenerics_id = $devicegenerics_id;

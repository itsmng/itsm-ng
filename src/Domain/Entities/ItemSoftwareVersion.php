...
#[ORM\UniqueConstraint(columns: ['itemtype', 'items_id', 'softwareversions_id'])]
#[ORM\Index(columns: ['items_id'])]
#[ORM\Index(columns: ['itemtype'])]
#[ORM\Index(columns: ['itemtype', 'items_id'])]
#[ORM\Index(columns: ['softwareversions_id'])]
#[ORM\Index(columns: ['entities_id', 'is_template_item', 'is_deleted_item'])]
#[ORM\Index(columns: ['is_template_item'])]
#[ORM\Index(columns: ['is_deleted_item'])]
#[ORM\Index(columns: ['is_dynamic'])]
#[ORM\Index(columns: ['date_install'])]

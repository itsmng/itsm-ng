...
#[ORM\Index(columns: ['networkequipmentmodels_id'])]
#[ORM\Index(columns: ['networks_id'])]
#[ORM\Index(columns: ['states_id'])]
#[ORM\Index(columns: ['users_id_tech'])]
#[ORM\Index(columns: ['networkequipmenttypes_id'])]
...
class Networkequipment
{
    ...
    #[ORM\Column(type: 'integer', options: ['default' => 0])]
    private $networkequipmenttypes_id;

    #[ORM\Column(type: 'integer', options: ['default' => 0])]
    private $networkequipmentmodels_id;
    ...
    public function getNetworkequipmenttypesId(): ?int
    {
        return $this->networkequipmenttypes_id;
    }

    public function setNetworkequipmenttypesId(int $networkequipmenttypes_id): self
    {
        $this->networkequipmenttypes_id = $networkequipmenttypes_id;

        return $this;
    }

    public function getNetworkequipmentmodelsId(): ?int
    {
        return $this->networkequipmentmodels_id;
    }

    public function setNetworkequipmentmodelsId(int $networkequipmentmodels_id): self
    {
        $this->networkequipmentmodels_id = $networkequipmentmodels_id;

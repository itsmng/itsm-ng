...
class Link
{
    ...
    #[ORM\Column(name: 'is_recursive', type: 'boolean', options: ['default' => true])]
    ...
    #[ORM\Column(name: 'data', type: 'text', nullable: true, length: 65535)]
    private $data;
    ...
    public function setOpenWindow(bool $openWindow): self
    {

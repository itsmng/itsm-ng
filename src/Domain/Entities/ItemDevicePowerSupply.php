...
#[ORM\Index(columns: ['devicepowersupplies_id'])]
...
class ItemDevicePowerSupply
{
    ...
    #[ORM\Column(type: 'integer', options: ['default' => 0])]
    private $devicepowersupplies_id;
    ...
    {
        return $this->devicepowersupplies_id;
    }

    public function setDevicePowerSupplyId(?int $devicepowersupplies_id): self
    {
        $this->devicepowersupplies_id = $devicepowersupplies_id;

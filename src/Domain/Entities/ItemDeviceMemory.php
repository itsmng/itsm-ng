...
#[ORM\Index(name: "devicememories_id", columns: ["devicememories_id"])]
#[ORM\Index(name: "specificity", columns: ["size"])]
...
class ItemDeviceMemory
{
    ...
    #[ORM\JoinColumn(name: 'devicememories_id', referencedColumnName: 'id', nullable: true)]
    private ?DeviceMemory $devicememory = null;

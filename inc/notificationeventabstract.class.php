                        ...
                        if (!isset($processed[$users_infos['language']][$key])) {
                            ...
                            if (
                                ...
                                if ($label == '') {
                                    ...
                                    $send_data['_locations_id']             = $item->input['locations_id'] ?? null;
                                    $send_data['_groups_id']                = $item->input['_groups_id_requester'] ?? null;
                                    $send_data['_itilcategories_id']        = $item->input['itilcategories_id'] ?? null;

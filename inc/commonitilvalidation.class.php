    ...
    public static function showFormMassiveAction()
    {
        ...
        $inputs = [
            User::getTypeName() => [
                ...
                ...getAjaxUserDropdownOptions(['validate_request', 'validate_incident']),
                'col_lg' => '12',
                'col_md' => '12',
            ],
            __('Comments') => [
    ...
    public function showForm($ID, $options = [])
    {
        ...
        if ($validation_admin && $ID <= 0) {
            ...
            $inputs[__('Approver')] = [
                ...
                'name' => 'users_id_validate[]',
                'id' => $approver_user_id,
                ...getAjaxUserDropdownOptions('validate_incident', ['entities_id' => $entity]),
            ...
            $inputs[__('Approver group')] = [
                ...
                'style' => 'display:none;',
                ...getAjaxDropdownOptionsByEntity(Group::class, $entity),
                'value' => 0,

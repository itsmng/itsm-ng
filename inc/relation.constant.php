...
$RELATION = [
   ...
   'glpi_groups' => [
      'glpi_cartridgeitems'        => 'tech_groups_id',
      'glpi_certificates'          => [
         'tech_groups_id',
         'groups_id',
      ],
      '_glpi_changes_groups'       => 'groups_id',
      'glpi_changetasks'           => 'tech_groups_id',
      'glpi_clusters'              => 'tech_groups_id',
      'glpi_computers'             => [
         'tech_groups_id',
         'groups_id',
      ],
      'glpi_consumableitems'       => 'tech_groups_id',
      'glpi_domains'               => 'tech_groups_id',
      'glpi_domainrecords'         => 'tech_groups_id',
      'glpi_enclosures'            => 'tech_groups_id',
      ...
      'glpi_passivedcequipments'   => 'tech_groups_id',
      'glpi_pdus'                  => 'tech_groups_id',
      'glpi_peripherals'           => [
         'tech_groups_id',
         'groups_id',
      ],
      ...
      'glpi_problemtasks'          => 'tech_groups_id',
      'glpi_projects'              => 'groups_id',
      'glpi_racks'                 => 'tech_groups_id',
      ...
      'glpi_tasktemplates'         => 'tech_groups_id',
      'glpi_tickettasks'           => 'tech_groups_id',
   ...
   'glpi_users' => [
      'glpi_cartridgeitems'           => 'tech_users_id',
      'glpi_certificates'             => [
         'tech_users_id',
         'users_id',
      ],
      ...
      'glpi_clusters'                 => 'tech_users_id',
      'glpi_computers'                => [
         'tech_users_id',
         'users_id',
      ],
      'glpi_consumableitems'          => 'tech_users_id',
      '_glpi_displaypreferences'      => 'users_id',
      'glpi_domains'                  => 'tech_users_id',
      'glpi_domainrecords'            => 'tech_users_id',
      'glpi_documents'                => 'users_id',
      'glpi_documents_items'          => 'users_id',
      'glpi_enclosures'               => 'tech_users_id',
      ...
      'glpi_passivedcequipments'      => 'tech_users_id',
      'glpi_pdus'                     => 'tech_users_id',
      'glpi_peripherals'              => [
         'tech_users_id',
         'users_id',
      ],
      ...
      'glpi_tasktemplates'            => 'tech_users_id',
      'glpi_tickets'                  => [
         'recipient_users_id',
         'lastupdater_users_id',
      ],
